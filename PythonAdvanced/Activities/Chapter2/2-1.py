...
class Machine:
    def process(self, incoming_production_line):
        print("----------------------")
        print("Machine {} started working.".format(self.__class__.__name__))
    ...
    def process(self, incoming_production_line=None):
        ...
        while len(production_line) != self.bottles_to_produce:
            if len(production_line) == 0:
                ...
                production_line.append(Bottle(liters=previous_bottle.liters * 3))
...
if __name__ == "__main__":
    ...
    print("----------------------")
    print("{} bottles produced {} packages".format(num_bottles, len(output)))
